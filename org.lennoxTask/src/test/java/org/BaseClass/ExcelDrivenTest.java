...
public class ExcelDrivenTest {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		System.setProperty("webdriver.chrome.driver", "C:\\Users\\manikandan.e\\eclipse-workspace\\ExcelMain\\src\\test\\resources\\Drivers\\chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.manage().window().maximize();
		driver.get("http://codenboxautomationlab.com/registration-form/");

		DataReader xlreader = new DataReader("C:\\Users\\manikandan.e\\eclipse-workspace\\ExcelMain\\src\\test\\java\\utility\\RegistrationData.xlsx");
		...
		for (int rowNum = 2; rowNum <= totalRow; rowNum++) {
			String isExecutable = xlreader.getCellData("TestData", "Executable", rowNum);
			switch (isExecutable) {
			case "Y":
